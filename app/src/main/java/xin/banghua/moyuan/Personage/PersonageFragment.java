...
public class PersonageFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        make_friend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                confirm_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        getFriendNumber("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=friendsnumber&m=moyuan");
                        dialog.dismiss();
                    }
                });
            }
            ...
            public void onClick(View v) {
                if (balcklist_btn.getText().toString().equals("加入黑名单")) {
                    ...
                    confirm_btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            deleteBlackList("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=deleteblacklist&m=moyuan");
                            dialog.dismiss();
                        }
                    });
                }
            ...
            public void onClick(View v) {
                ...
                confirm_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        deleteFriend("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=deletefriend&m=moyuan");
                        dialog.dismiss();
                    }
                });
        ...
        addSawMe("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=addsawme&m=moyuan");
...
//                    startActivity(intent);
                ...
                case 4:
                    ...
                    if (msg.obj.toString().equals("好友人数未超过限制")){
                        ...
                        makeFriend("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=addfriend&m=moyuan");
                    }else {
