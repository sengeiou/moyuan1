    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.weixin_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getUnifiedorder("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=payunifiedorder&m=moyuan",currentItem.getVipid());
            }
        });
        viewHolder.alipay_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                alipayorder("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=alipayaddorder&m=moyuan",currentItem.getVipid());
            }
        });
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 2:
                    ...
                    alipay("https://www.banghua.xin/alipay-sdk-PHP/alipaymoyuan.php",msg.obj.toString());
                    break;
                case 3:
                    alipay("https://www.banghua.xin/alipay-sdk-PHP/alipaymoyuan.php",msg.obj.toString());
                    break;
