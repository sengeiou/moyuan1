...
import xin.banghua.moyuan.Adapter.PostAdapter;
import xin.banghua.moyuan.Adapter.PostHead;
...
public class PostListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getDataPosthead("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=postdetail&m=moyuan");
        initPostHead();
    }
    ...
    public void initPostHead(){
        ...
        getDataFollowlist("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=postdetail&m=moyuan");
