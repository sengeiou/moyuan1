...
import xin.banghua.moyuan.Main5Branch.SomeonesluntanActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        release_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                postFabugentie("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=fabugentie&m=moyuan");
