...
import xin.banghua.moyuan.Adapter.NewFriendsAdapter;
import xin.banghua.moyuan.BadgeBottomNav;
import xin.banghua.moyuan.Main2Activity;
...
public class NewFriend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataFriends("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=friendsapply&m=moyuan");
