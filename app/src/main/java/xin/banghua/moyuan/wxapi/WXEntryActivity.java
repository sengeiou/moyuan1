package xin.banghua.moyuan.wxapi;
...
import xin.banghua.moyuan.Main3Branch.RongyunConnect;
...
import xin.banghua.moyuan.Signin.Userset;
import xin.banghua.moyuan.Uniquelogin;
            ...
            switch (msg.what){
                ...
                case 2:
                    try {
                        ...
                        saveUserinfo("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=weinxinregister&m=moyuan",openid,nickname,portrait);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    break;
                case 3:
                    ...
                    try {
                        ...
                        if (jsonObject.getString("type").equals("1")){
                            //注册融云
                            //跳转首页
                            postRongyunUserRegisterExist("https://rongyun.banghua.xin/RongCloud/example/User/userregistermoyuan.php",jsonObject.getString("id"),jsonObject.getString("nickname"),jsonObject.getString("portrait"));
                        }else if (jsonObject.getString("type").equals("2")){
                            //不存在，注册融云，然后跳转设置页
                            postRongyunUserRegister("https://rongyun.banghua.xin/RongCloud/example/User/userregistermoyuan.php",jsonObject.getString("id"),jsonObject.getString("nickname"),jsonObject.getString("portrait"));
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
