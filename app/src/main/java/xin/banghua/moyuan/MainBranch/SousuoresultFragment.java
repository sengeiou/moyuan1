...
public class SousuoresultFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments().getString("type")=="direct") {
            //获取用户信息
            getDataUserinfo("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=directsousuo&m=moyuan",getArguments(),"1");
        }else if(getArguments().getString("type")=="condition"){
            getDataUserinfo("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=conditionsousuo&m=moyuan",getArguments(),"1");
        }
    }
    ...
    private void initRecyclerView(View view){
        ...
        recyclerView.setOnPullLoadMoreListener(new PullLoadMoreRecyclerView.PullLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                getDataUserinfo("https://applet.banghua.xin/app/index.php?i=99999&c=entry&a=webapp&do=conditionsousuo&m=moyuan",getArguments(),pageindex+"");
